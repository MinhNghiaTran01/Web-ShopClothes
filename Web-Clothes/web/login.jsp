        ...
        <div class="container"> 
            ...
            <div class="noidung dn nd1">
                <form action="login">
                    ...
                    <input type="text" class="input dn" name="user" placeholder="Email/SDT...">
                     <input type="text" class="input dn" name="pass" placeholder="Mat khau...">
                    <label>
                         <input class="" value="1"  type="checkbox" name="rem"/>
